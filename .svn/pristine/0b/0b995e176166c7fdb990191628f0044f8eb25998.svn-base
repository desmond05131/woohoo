Public Class GoodsReceivedNoteScript
    ...
    Public Sub OnFormShow(e As AutoCount.Invoicing.Purchase.GoodsReceivedNote.FormGoodsReceivedNoteEntry.FormShowEventArgs)
    ...
    End Sub
    Public Sub OnSwitchToEditMode(e As AutoCount.Invoicing.Purchase.GoodsReceivedNote.FormGoodsReceivedNoteEntry.FormEventArgs)
