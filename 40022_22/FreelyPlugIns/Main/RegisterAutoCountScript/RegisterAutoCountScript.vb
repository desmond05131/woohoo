...
#End Region
    ...
    Public Sub Register()
        ...
        AutoCount.Scripting.ScriptManager.GetOrCreate(Me.DBSetting).RegisterByType("CS", GetType(CashSaleScript))
        AutoCount.Scripting.ScriptManager.GetOrCreate(Me.DBSetting).RegisterByType("CashSaleCommandForm", GetType(CashSaleScript))
